...
public class arthmCalc {
	...
	public static void main(String[] args) {
		...
		case 2: 
			System.out.println("Enter any two number to subtract");
			n1 = sc.nextInt();
			n2 = sc.nextInt(); 
			result = n1-n2;
		...
		case 3: 
			System.out.println("Enter any to number to multiply");
			n1 = sc.nextInt(); 
			n2 = sc.nextInt();
			result = n1*n2;
		...
		case 4:
			System.out.println("Enter any two number to divide");
			n1 = sc.nextInt();
			n2 = sc.nextInt(); 
			result = n1/n2;
		...
		default:System.out.println("You have entered Invalid cholce");
			break;
